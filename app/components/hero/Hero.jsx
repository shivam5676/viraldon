  ...
  useEffect(() => {
    if (heroRef.current && titleRef.current && subtitleRef.current && buttonRef.current) {
      ...
      backgroundTl.to(heroRef.current, {
        background: "radial-gradient(circle at 20% 50%, rgba(99, 102, 241, 0.15) 0%, rgba(168, 85, 247, 0.15) 25%, rgba(15, 23, 42, 0.15) 50%)",
        duration: 8,
        ease: "power1.inOut"
      });
    ...
    >
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="text-center">
          <h1 
            ref={titleRef}
            className="text-4xl md:text-7xl font-extrabold tracking-tight bg-gradient-to-r from-blue-600 via-purple-600 to-indigo-600 bg-clip-text text-transparent mb-6 animate-fade-in"
          >
          ...
          >
            ...
            beautiful websites, and powerful software solutions that drive real results.
          </p>
          <div 
            ref={buttonRef}
