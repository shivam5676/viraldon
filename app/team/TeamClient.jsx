...
export default function TeamClient() {
  ...
  const teamMembers = [
    ...
    },
    {
      ...
      social: {
        linkedin: "https://www.linkedin.com/in/shivam-singh-rajawat/",
        twitter: "#"
      }
    },
    {
    ...
    },
    {
      ...
      bio: "Data-driven marketing professional specializing in SEO and content strategy.",
    ...
    },
    {
      ...
      role: "UX Designer",
      department: "Design",
      bio: "User experience specialist focused on creating intuitive and engaging digital experiences.",
    ...
    },
    {
      ...
      department: "Development",
      bio: "Backend specialist with expertise in cloud infrastructure and database optimization.",
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 py-32 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-16">
          ...
          >
            Meet the talented professionals dedicated to helping your business thrive in the digital world
          </p>
        </div>
            ...
            >
              <div className="relative">
                ...
                <div className="bg-gradient-to-r from-blue-500 to-purple-600 h-56 flex items-center justify-center relative overflow-hidden">
                  ...
                  <div className="bg-gray-200 border-2 border-dashed rounded-2xl w-36 h-36 flex items-center justify-center relative z-10" style={{display: 'none'}}>
              ...
              <div className="p-8">
                ...
                <div className="flex space-x-4">
                  <a href={member.social.linkedin} className="text-gray-500 hover:text-blue-600 dark:hover:text-blue-400 transition-colors bg-gray-100 dark:bg-gray-700 p-3 rounded-full">
                    <span className="sr-only">LinkedIn</span>
                    <div className="w-5 h-5 bg-gray-400 rounded-full"></div>
                  </a>
                  <a href={member.social.twitter} className="text-gray-500 hover:text-blue-600 dark:hover:text-blue-400 transition-colors bg-gray-100 dark:bg-gray-700 p-3 rounded-full">
        ...
        >
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl md:text-5xl font-bold mb-8">Our <span className="bg-gradient-to-r from-yellow-300 to-pink-300 bg-clip-text text-transparent">Culture</span></h2>
            <p className="text-xl mb-12">
              We believe in fostering an environment of creativity, collaboration, and continuous learning. 
              Our team is passionate about staying ahead of industry trends and delivering exceptional results for our clients.
            </p>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mt-16">
              {[
                { icon: "🤝", title: "Collaboration", description: "We work together to achieve common goals" },
                { icon: "🚀", title: "Innovation", description: "We embrace new ideas and cutting-edge technologies" },
                { icon: "🌱", title: "Growth", description: "We invest in our team's professional development" }
              ].map((item, index) => (
                <div key={index} className="text-center group">
                  <div className="text-6xl mb-6 transition-transform duration-300 group-hover:scale-110">{item.icon}</div>
